...
import { PolarGrid, PolarAngleAxis, Radar, Tooltip } from "recharts";
import { ResponsiveContainer, RadarChart } from "recharts";
import { AppDialog, AppDialogActions } from "@elements/app-dialog";
import { TResultDetailDialogProps } from "@/types/modules";
  ...
  const chartData = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        label: t("dashboard.student.results.intelligences.BODILY_KINESTHETIC"),
        value: result.bodilyKinesthetic,
      },
      {
        key: "VISUAL_SPATIAL",
        label: t("dashboard.student.results.intelligences.VISUAL_SPATIAL"),
        value: result.visualSpatial,
      },
      {
        key: "NATURALISTIC",
        label: t("dashboard.student.results.intelligences.NATURALISTIC"),
        value: result.naturalistic,
      },
      {
        key: "INTERPERSONAL",
        label: t("dashboard.student.results.intelligences.INTERPERSONAL"),
        value: result.interpersonal,
      },
      {
        key: "INTRAPERSONAL",
        label: t("dashboard.student.results.intelligences.INTRAPERSONAL"),
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <p className="text-xs text-muted-foreground">
                  {t("dashboard.student.results.detail.assignment")}
                </p>
              ...
              <div>
                ...
                <p className="mt-1 font-medium">
                  {result.dominantIntelligence
                    ? t(
                        `dashboard.student.results.intelligences.${result.dominantIntelligence}`,
                      )
          ...
          <div className="grid gap-5 lg:grid-cols-2">
            <div className="rounded-2xl border border-border/60 bg-card/60 p-4">
              <h4 className="mb-3 text-sm font-semibold text-foreground">
                {t("dashboard.student.results.detail.summary")}
              </h4>
