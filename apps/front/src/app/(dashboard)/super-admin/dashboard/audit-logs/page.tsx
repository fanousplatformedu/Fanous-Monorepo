...
import SuperAdminAuditLogsPage from "@modules/Dashboard/SuperAdmin/AuditLogs";

const AuditLogsSuperAdminDashboard = () => {
  const { t } = useI18n();
  ...
  return (
    <DashboardShell
      header={
        <DashboardHeader
          title={t("dashboard.superAdmin.auditLogsPage.header.title")}
          description={t(
            "dashboard.superAdmin.auditLogsPage.header.description",
          )}
        />
      }
      sidebar={
...
export default AuditLogsSuperAdminDashboard;
