...
export type AssessmentResultItem = {
  __typename?: 'AssessmentResultItem';
  bodilyKinesthetic: Scalars['Float']['output'];
  createdAt: Scalars['DateTime']['output'];
...
export type AssessmentResultList = {
  ...
  items: Array<AssessmentResultItem>;
  skip: Scalars['Int']['output'];
  take: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
};
...
export type AssignmentDetailInput = {
  assignmentId: Scalars['String']['input'];
...
export type AssignmentEntity = {
  ...
  counselorReviews: Array<CounselorReviewEntity>;
...
export type CounselorReviewEntity = {
  __typename?: 'CounselorReviewEntity';
  assignmentId: Scalars['String']['output'];
...
export type Mutation = {
  ...
  updateAssignment: SchoolAssignment;
...
export type ParentAssessmentResult = {
  ...
  naturalistic: Scalars['Float']['output'];
  scoreSummary: Maybe<Scalars['String']['output']>;
  student: Maybe<ParentAssessmentStudent>;
  studentAssignmentId: Scalars['String']['output'];
  studentId: Scalars['String']['output'];
  visualSpatial: Scalars['Float']['output'];
};
...
export type ParentAssessmentStudent = {
  __typename?: 'ParentAssessmentStudent';
...
export type Query = {
  ...
  schoolStudentAnalytics: SchoolStudentAnalyticsEntity;
...
export type QueryAssignmentDetailArgs = {
  input: AssignmentDetailInput;
};
...
export type QuerySchoolMemberArgs = {
  input: SchoolMemberInput;
};
...
export type SchoolMemberInput = {
  userId: Scalars['String']['input'];
};

export type SchoolStudentAnalyticsEntity = {
  __typename?: 'SchoolStudentAnalyticsEntity';
...
export type StudentActivity = {
  ...
  id: Scalars['String']['output'];
  metadata: Maybe<Scalars['JSON']['output']>;
  student: Maybe<StudentActivityStudent>;
  studentId: Scalars['String']['output'];
  title: Scalars['String']['output'];
...
export type StudentActivityStudent = {
  __typename?: 'StudentActivityStudent';
  avatarUrl: Maybe<Scalars['String']['output']>;
  email: Maybe<Scalars['String']['output']>;
  firstName: Maybe<Scalars['String']['output']>;
  id: Scalars['String']['output'];
...
export type StudentAssignmentEntity = {
  __typename?: 'StudentAssignmentEntity';
  assignmentId: Scalars['String']['output'];
  completionRate: Scalars['Float']['output'];
  createdAt: Scalars['DateTime']['output'];
  evaluatedAt: Maybe<Scalars['DateTime']['output']>;
  id: Scalars['ID']['output'];
  result: Maybe<AssessmentResultItem>;
  startedAt: Maybe<Scalars['DateTime']['output']>;
...
export type UpdateAssignmentInput = {
  ...
  targetGradeId?: InputMaybe<Scalars['String']['input']>;
  targetMode?: InputMaybe<Scalars['String']['input']>;
  targetStudentIds?: InputMaybe<Array<Scalars['String']['input']>>;
...
export type HeaderCurrentUserQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, role: string, email: string | null, firstName: string | null, lastName: string | null, schoolId: string | null, avatarUrl: string | null, forcePasswordChange: boolean | null } };
...
export type MyChildrenQuery = { __typename?: 'Query', myChildren: { __typename?: 'ParentChildList', take: number, skip: number, total: number, items: Array<{ __typename?: 'ParentChild', id: string, email: string | null, mobile: string | null, firstName: string | null, lastName: string | null, relation: ParentRelationType, isPrimary: boolean, avatarUrl: string | null, createdAt: string | null, currentEnrollment: { __typename?: 'ParentChildCurrentEnrollment', id: string, startedAt: string, endedAt: string | null, classroom: { __typename?: 'ParentChildEnrollmentClassroom', id: string, name: string, grade: { __typename?: 'ParentChildEnrollmentGrade', id: string, name: string } | null } | null } | null }> } };
...
export type ParentChildDetailQuery = { __typename?: 'Query', parentChildDetail: { __typename?: 'ParentChildDetail', id: string, email: string | null, mobile: string | null, relation: ParentRelationType, firstName: string | null, lastName: string | null, isPrimary: boolean, avatarUrl: string | null, currentEnrollment: { __typename?: 'ParentChildCurrentEnrollment', id: string, startedAt: string, endedAt: string | null, classroom: { __typename?: 'ParentChildEnrollmentClassroom', id: string, name: string, grade: { __typename?: 'ParentChildEnrollmentGrade', id: string, name: string } | null } | null } | null } };
...
export type ParentChildResultsQuery = { __typename?: 'Query', parentChildResults: { __typename?: 'ParentAssessmentResultList', take: number, skip: number, total: number, items: Array<{ __typename?: 'ParentAssessmentResult', id: string, studentId: string, musical: number, createdAt: string, linguistic: number, logicalMath: number, scoreSummary: string | null, naturalistic: number, interpersonal: number, intrapersonal: number, visualSpatial: number, assignmentTitle: string, bodilyKinesthetic: number, studentAssignmentId: string, dominantIntelligence: ParentIntelligenceKey | null, student: { __typename?: 'ParentAssessmentStudent', id: string, email: string | null, mobile: string | null, firstName: string | null, lastName: string | null, avatarUrl: string | null } | null }> } };
...
export type ParentResultDetailQuery = { __typename?: 'Query', parentResultDetail: { __typename?: 'ParentAssessmentResult', id: string, studentId: string, musical: number, createdAt: string, linguistic: number, logicalMath: number, naturalistic: number, scoreSummary: string | null, interpersonal: number, intrapersonal: number, visualSpatial: number, assignmentTitle: string, bodilyKinesthetic: number, studentAssignmentId: string, dominantIntelligence: ParentIntelligenceKey | null, student: { __typename?: 'ParentAssessmentStudent', id: string, email: string | null, mobile: string | null, firstName: string | null, lastName: string | null, avatarUrl: string | null } | null, careerMatches: Array<{ __typename?: 'ParentCareerMatch', title: string, score: number, fitReason: string | null, description: string | null }> | null } };
...
export type ParentChildActivitiesQuery = { __typename?: 'Query', parentChildActivities: { __typename?: 'StudentActivityList', take: number, skip: number, total: number, items: Array<{ __typename?: 'StudentActivity', id: string, studentId: string, type: StudentActivityType, title: string, metadata: unknown | null, createdAt: string, description: string | null, student: { __typename?: 'StudentActivityStudent', id: string, email: string | null, mobile: string | null, firstName: string | null, lastName: string | null, avatarUrl: string | null } | null }> } };
...
export type ParentCounselingSessionsQuery = { __typename?: 'Query', parentCounselingSessions: { __typename?: 'ParentCounselingSessionList', take: number, skip: number, total: number, items: Array<{ __typename?: 'ParentCounselingSession', id: string, note: string | null, title: string, status: ParentCounselingSessionStatus, createdAt: string, canceledAt: string | null, meetingUrl: string | null, scheduledAt: string | null, counselorId: string | null, studentId: string, student: { __typename?: 'ParentCounselingSessionStudent', id: string, firstName: string | null, lastName: string | null, email: string | null, mobile: string | null, avatarUrl: string | null } | null }> } };
...
export type SchoolAdminLoginMutation = { __typename?: 'Mutation', adminLogin: { __typename?: 'AuthPayload', role: string, userId: string, message: string, schoolId: string | null, firstName: string | null, lastName: string | null } };

export type SchoolAdminMeQueryVariables = Exact<{ [key: string]: never; }>;


export type SchoolAdminMeQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, role: string, email: string | null, schoolId: string | null, username: string | null, firstName: string | null, lastName: string | null, avatarUrl: string | null, forcePasswordChange: boolean | null } };
...
export type SchoolMembersQuery = { __typename?: 'Query', schoolMembers: { __typename?: 'UserList', total: number, take: number, skip: number, items: Array<{ __typename?: 'User', id: string, role: string, email: string | null, mobile: string | null, status: string, firstName: string | null, lastName: string | null, createdAt: string }> } };

export type SchoolMemberQueryVariables = Exact<{
  input: SchoolMemberInput;
}>;


export type SchoolMemberQuery = { __typename?: 'Query', schoolMember: { __typename?: 'User', id: string, role: string, email: string | null, mobile: string | null, status: string, firstName: string | null, lastName: string | null, username: string | null, forcePasswordChange: boolean | null, isActive: boolean } };
...
export type SchoolAdminAccessRequestsQuery = { __typename?: 'Query', accessRequests: { __typename?: 'AccessRequestList', total: number, take: number, skip: number, items: Array<{ __typename?: 'AccessRequest', id: string, email: string | null, mobile: string | null, status: string, firstName: string | null, lastName: string | null, createdAt: string, reviewedAt: string | null, rejectReason: string | null, reviewedById: string | null, requestedRole: string, approvedUserId: string | null }> } };
...
export type AssignmentDetailQueryVariables = Exact<{
  input: AssignmentDetailInput;
}>;


export type AssignmentDetailQuery = { __typename?: 'Query', AssignmentDetail: { __typename?: 'AssignmentEntity', id: string, schoolId: string, title: string, description: string | null, status: AssignmentStatus, targetMode: AssignmentTargetMode, userId: string | null, dueAt: string | null, targetStudentIds: Array<string> | null, targetGradeId: string | null, targetClassroomId: string | null, createdAt: string | null, updatedAt: string | null, publishedAt: string | null, counselorReviews: Array<{ __typename?: 'CounselorReviewEntity', id: string, status: CounselorReviewStatus }>, studentAssignments: Array<{ __typename?: 'StudentAssignmentEntity', id: string, status: StudentAssignmentStatus, createdAt: string, updatedAt: string, assignmentId: string, studentId: string, startedAt: string | null, submittedAt: string | null, evaluatedAt: string | null, completionRate: number, student: { __typename?: 'Student', id: string, firstName: string | null, lastName: string | null }, result: { __typename?: 'AssessmentResultItem', id: string } | null }> } };
...
export type UpdateAssignmentMutation = { __typename?: 'Mutation', updateAssignment: { __typename?: 'SchoolAssignment', id: string, title: string, dueAt: string | null, status: string, schoolId: string, updatedAt: string, createdAt: string, targetMode: string, publishedAt: string | null, createdById: string, description: string | null, targetGradeId: string | null, targetClassroomId: string | null } };
...
export type AssessmentResultsQuery = { __typename?: 'Query', assessmentResults: { __typename?: 'AssessmentResultList', take: number, skip: number, total: number, items: Array<{ __typename?: 'AssessmentResultItem', id: string, musical: number, schoolId: string, studentId: string, createdAt: string, linguistic: number, logicalMath: number, summaryJson: unknown | null, dominantKey: string | null, naturalistic: number, visualSpatial: number, interpersonal: number, intrapersonal: number, bodilyKinesthetic: number, studentAssignmentId: string, student: { __typename?: 'AssessmentStudent', id: string, email: string | null, firstName: string | null, lastName: string | null } | null, studentAssignment: { __typename?: 'StudentAssignment', id: string, status: string, startedAt: string | null, studentId: string, submittedAt: string | null, evaluatedAt: string | null, assignmentId: string, completionRate: number, assignment: { __typename?: 'AssignmentRef', id: string, title: string } | null } | null }> } };
...
export type SchoolCounselorsQuery = { __typename?: 'Query', schoolCounselors: { __typename?: 'SchoolCounselorList', take: number, skip: number, total: number, items: Array<{ __typename?: 'SchoolCounselor', id: string, email: string | null, mobile: string | null, status: UserStatus, firstName: string | null, lastName: string | null, avatarUrl: string | null }> } };
...
export type SchoolStudentsForCounselorAssignmentQuery = { __typename?: 'Query', schoolStudentsForCounselorAssignment: { __typename?: 'SchoolStudentAssignmentCandidateList', take: number, skip: number, total: number, items: Array<{ __typename?: 'SchoolStudentAssignmentCandidate', id: string, email: string | null, mobile: string | null, status: UserStatus, firstName: string | null, lastName: string | null, avatarUrl: string | null }> } };
...
export type SchoolStudentAnalyticsQueryVariables = Exact<{ [key: string]: never; }>;


export type SchoolStudentAnalyticsQuery = { __typename?: 'Query', schoolStudentAnalytics: { __typename?: 'SchoolStudentAnalyticsEntity', active: number, inActive: number, total: number } };
...
export type AssessmentResultQuery = { __typename?: 'Query', assessmentResult: { __typename?: 'AssessmentResultItem', bodilyKinesthetic: number, createdAt: string, dominantKey: string | null, id: string, interpersonal: number, intrapersonal: number, linguistic: number, logicalMath: number, musical: number, naturalistic: number, schoolId: string, studentAssignmentId: string, studentId: string, summaryJson: unknown | null, visualSpatial: number, student: { __typename?: 'AssessmentStudent', id: string, email: string | null, firstName: string | null, lastName: string | null } | null, studentAssignment: { __typename?: 'StudentAssignment', id: string, status: string, startedAt: string | null, studentId: string, submittedAt: string | null, evaluatedAt: string | null, assignmentId: string, completionRate: number, assignment: { __typename?: 'AssignmentRef', id: string, title: string } | null } | null } };
...
export type SubmitAccessRequestMutation = { __typename?: 'Mutation', submitAccessRequest: { __typename?: 'AccessRequest', id: string, status: string, schoolId: string, requestedRole: string, email: string | null, mobile: string | null, firstName: string | null, lastName: string | null, createdAt: string } };
...
export type SchoolUserMeQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, role: string, status: string, schoolId: string | null, email: string | null, mobile: string | null, firstName: string | null, lastName: string | null, createdAt: string } };
...
export type UpdateMeMutation = { __typename?: 'Mutation', updateMe: { __typename?: 'User', id: string, firstName: string | null, lastName: string | null, email: string | null, mobile: string | null, updatedAt: string } };
...
export type SuperAdminLoginMutation = { __typename?: 'Mutation', adminLogin: { __typename?: 'AuthPayload', message: string, userId: string, role: string, schoolId: string | null, firstName: string | null, lastName: string | null } };

export type SuperAdminMeQueryVariables = Exact<{ [key: string]: never; }>;


export type SuperAdminMeQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, role: string, status: string, schoolId: string | null, email: string | null, mobile: string | null, firstName: string | null, lastName: string | null, createdAt: string } };
...
export type SuperAdminAccessRequestsQuery = { __typename?: 'Query', accessRequests: { __typename?: 'AccessRequestList', total: number, take: number, skip: number, items: Array<{ __typename?: 'AccessRequest', id: string, status: string, requestedRole: string, email: string | null, mobile: string | null, firstName: string | null, lastName: string | null, reviewedById: string | null, reviewedAt: string | null, rejectReason: string | null, approvedUserId: string | null, createdAt: string }> } };
...
export type UpdateAdminProfileMutation = { __typename?: 'Mutation', updateAdminProfile: { __typename?: 'AdminProfileResult', id: string, email: string | null, message: string, firstName: string | null, lastName: string | null } };
...
export const SchoolMemberDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"SchoolMember"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SchoolMemberInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"schoolMember"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"role"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"mobile"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"forcePasswordChange"}},{"kind":"Field","name":{"kind":"Name","value":"isActive"}}]}}]}}]} as unknown as DocumentNode<SchoolMemberQuery, SchoolMemberQueryVariables>;
...
export const AssignmentDetailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AssignmentDetail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"AssignmentDetailInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"AssignmentDetail"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"schoolId"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"targetMode"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"dueAt"}},{"kind":"Field","name":{"kind":"Name","value":"targetStudentIds"}},{"kind":"Field","name":{"kind":"Name","value":"targetGradeId"}},{"kind":"Field","name":{"kind":"Name","value":"targetClassroomId"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"publishedAt"}},{"kind":"Field","name":{"kind":"Name","value":"counselorReviews"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}},{"kind":"Field","name":{"kind":"Name","value":"studentAssignments"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"assignmentId"}},{"kind":"Field","name":{"kind":"Name","value":"studentId"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"submittedAt"}},{"kind":"Field","name":{"kind":"Name","value":"evaluatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"completionRate"}},{"kind":"Field","name":{"kind":"Name","value":"student"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}}]}},{"kind":"Field","name":{"kind":"Name","value":"result"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]}}]} as unknown as DocumentNode<AssignmentDetailQuery, AssignmentDetailQueryVariables>;
...
export const UpdateAssignmentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateAssignment"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateAssignmentInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateAssignment"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"dueAt"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"schoolId"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"targetMode"}},{"kind":"Field","name":{"kind":"Name","value":"publishedAt"}},{"kind":"Field","name":{"kind":"Name","value":"createdById"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"targetGradeId"}},{"kind":"Field","name":{"kind":"Name","value":"targetClassroomId"}}]}}]}}]} as unknown as DocumentNode<UpdateAssignmentMutation, UpdateAssignmentMutationVariables>;
...
export const SchoolStudentAnalyticsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"schoolStudentAnalytics"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"schoolStudentAnalytics"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"inActive"}},{"kind":"Field","name":{"kind":"Name","value":"total"}}]}}]}}]} as unknown as DocumentNode<SchoolStudentAnalyticsQuery, SchoolStudentAnalyticsQueryVariables>;
export const AssessmentResultDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AssessmentResult"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"AssessmentResultInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"assessmentResult"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bodilyKinesthetic"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"dominantKey"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"interpersonal"}},{"kind":"Field","name":{"kind":"Name","value":"intrapersonal"}},{"kind":"Field","name":{"kind":"Name","value":"linguistic"}},{"kind":"Field","name":{"kind":"Name","value":"logicalMath"}},{"kind":"Field","name":{"kind":"Name","value":"musical"}},{"kind":"Field","name":{"kind":"Name","value":"naturalistic"}},{"kind":"Field","name":{"kind":"Name","value":"schoolId"}},{"kind":"Field","name":{"kind":"Name","value":"studentAssignmentId"}},{"kind":"Field","name":{"kind":"Name","value":"studentId"}},{"kind":"Field","name":{"kind":"Name","value":"summaryJson"}},{"kind":"Field","name":{"kind":"Name","value":"visualSpatial"}},{"kind":"Field","name":{"kind":"Name","value":"student"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}}]}},{"kind":"Field","name":{"kind":"Name","value":"studentAssignment"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"startedAt"}},{"kind":"Field","name":{"kind":"Name","value":"studentId"}},{"kind":"Field","name":{"kind":"Name","value":"submittedAt"}},{"kind":"Field","name":{"kind":"Name","value":"evaluatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"assignmentId"}},{"kind":"Field","name":{"kind":"Name","value":"completionRate"}},{"kind":"Field","name":{"kind":"Name","value":"assignment"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}}]}}]}}]}}]} as unknown as DocumentNode<AssessmentResultQuery, AssessmentResultQueryVariables>;
